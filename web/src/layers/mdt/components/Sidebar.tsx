...
const homeData = [{ link: "", label: "Gösterge Paneli", icon: IconLayoutDashboard }];

const pagesData = [
	{ link: "profiles", label: "Profiller", icon: IconUsers },
	{ link: "incidents", label: "Olaylar", icon: IconScript },
	{ link: "reports", label: "Raporlar", icon: IconFileDescription },
	{ link: "vehicles", label: "Araçlar", icon: IconCar },
	{ link: "dispatch", label: "Merkez", icon: IconMap2 },
	// {link: 'boloWarrants', label: 'Bolos & Warrants', icon: IconZoomExclamation},
];

const staffData = [
	{ label: "Personel", link: "roster", icon: IconUserShield },
	{ label: "Suçlar", link: "charges", icon: IconGavel },
